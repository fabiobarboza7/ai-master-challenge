...
**20:40 — Publicação.** Fork, push e PR abertos. O protótipo foi para a Vercel como exportação estática, em **https://triagem-assistida.vercel.app**, e o link entrou no README: o enunciado pede "algo rodando", e um link clicável entrega isso sem exigir que o avaliador rode nada. Conferido sem estar logado: página e os cinco arquivos de dados carregam, sem erro de console.
